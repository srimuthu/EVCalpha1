...
class LaneDetect():
    ...
    def __RescaleImage(self):
        ...
        self.__ROI_h = int(self.__size_y*c_RoiRatio)
        self.__ROI_x = 0
    ...
    def __RobotPath(self):
        ...
        cv2.polylines(self.__imgRoi, [self.__polyPoints], True, (0, 0, 0), 6)
    ...
    def DetectLane(self, img_orig):
        ...
        cv2.imshow("img",self.__imgRoiColor)

if __name__ == '__main__':

    cap = cv2.VideoCapture("petar4.h264")
